...
interface NativeModuleInterface {
    ...
    ubrn_uniffi_uniffi_russh_fn_clone_commandstreamcallback(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): bigint;
    ubrn_uniffi_uniffi_russh_fn_free_commandstreamcallback(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_uniffi_russh_fn_clone_commandstreamsession(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): bigint;
    ubrn_uniffi_uniffi_russh_fn_free_commandstreamsession(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): void;
    ...
    ubrn_uniffi_uniffi_russh_fn_init_callback_vtable_commandstreamcallback(vtable: UniffiVTableCallbackInterfaceUniffiRusshCommandStreamCallback): void;
    ...
    ubrn_uniffi_uniffi_russh_fn_func_default_run_command_max_output_bytes(uniffi_out_err: UniffiRustCallStatus): bigint;
    ...
    ubrn_uniffi_uniffi_russh_fn_func_max_run_command_max_output_bytes(uniffi_out_err: UniffiRustCallStatus): bigint;
    ...
    ubrn_uniffi_uniffi_russh_fn_method_sshconnection_run_command(uniffiSelf: bigint, opts: Uint8Array): bigint;
    ubrn_uniffi_uniffi_russh_fn_method_sshconnection_start_command_stream(uniffiSelf: bigint, opts: Uint8Array): bigint;
    ...
    ubrn_uniffi_internal_fn_method_commandstreamcallback_ffi__bless_pointer(pointer: bigint, uniffi_out_err: UniffiRustCallStatus): UniffiGcObject;
    ...
    ubrn_uniffi_internal_fn_method_commandstreamsession_ffi__bless_pointer(pointer: bigint, uniffi_out_err: UniffiRustCallStatus): UniffiGcObject;
...
type UniffiCallbackInterfaceUniffiRusshCommandStreamCallbackMethod0 = (uniffiHandle: bigint, event: Uint8Array) => UniffiResult<void>;
type UniffiCallbackInterfaceCloneUniffiRusshCommandStreamCallback = (handle: bigint) => UniffiResult<void>;
type UniffiCallbackInterfaceFreeUniffiRusshCommandStreamCallback = (handle: bigint) => void;
