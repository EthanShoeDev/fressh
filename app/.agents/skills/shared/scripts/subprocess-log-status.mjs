...
function printUsage() {
  writeToStream(
    ...
    [
      "Usage:",
      "  node .agents/skills/shared/scripts/subprocess-log-status.mjs --log <path> [--tail <lines>] [--baseline-size <bytes>] [--baseline-updated-at <iso>]",
      "",
      "Examples:",
      "  node .agents/skills/shared/scripts/subprocess-log-status.mjs --log /tmp/rloop-review-abc123.md",
      "  node .agents/skills/shared/scripts/subprocess-log-status.mjs --log /tmp/rloop-review-abc123.md --tail 20 --baseline-size 4096 --baseline-updated-at 2026-03-10T00:05:00.000Z",
      "",
    ].join("\n")
  );
}
